...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Tray Bills  Atlanta Music Artist & Creator" },
      { name: "description", content: "Tray Bills is an Atlanta music artist, content creator, and fashion influencer leading the Billionaire Gang." },
      { property: "og:title", content: "Tray Bills  Atlanta Music Artist & Creator" },
